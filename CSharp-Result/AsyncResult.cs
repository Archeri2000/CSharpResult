...
namespace CSharp_Result
{
    ...
    public static class AsyncResult
    {
        ...
        public static Func<TInput, Task<Result<TSucc>>> ToAsyncResultFunc<TInput, TSucc>(
            this Func<TInput, Task<TSucc>> func, ExceptionFilter mapException)
        {
            return (async x =>
            {
                try
        ...
        public static Func<TInput, Task<Result<Unit>>> ToAsyncResultFunc<TInput>(this Func<TInput, Task> func,
        ...
        /// <typeparam name="TSucc">Output type</typeparam>
        /// <returns>Async Function that outputs a Success if successful, converting relevant Exceptions into Failure</returns>
        public static Func<TInput, Task<Result<TSucc>>> ToAsyncResultFunc<TInput, TSucc>(this Func<TInput, TSucc> func,
            ExceptionFilter mapException)
        {
            return (async x =>
            {
        ...
        /// <typeparam name="TInput">Input type</typeparam>
        /// <returns>Async Function that outputs a Success of Unit if successful, converting relevant Exceptions into Failure</returns>
        public static Func<TInput, Task<Result<Unit>>> ToAsyncResultFunc<TInput>(this Action<TInput> func,
            ExceptionFilter mapException)
        {
            return (async x =>
            {
        ...
        public static Task<TSucc> SuccessOrDefault<TSucc>(this Task<Result<TSucc>> result,
        ...
        public static Task<Exception> FailureOrDefault<TSucc>(this Task<Result<TSucc>> result,
    ...
    public static class AsyncResultExtensions
    {
        ...
        public static async Task<Result<TSucc>> MapFailure<TSucc>(this Task<Result<TSucc>> res,
        ...
        public static async Task<T> MatchAwait<TInput, T>(this Task<Result<TInput>> res, Func<TInput, Task<T>> Success,
        ...
        /// <typeparam name="TInput">Type of the input Result</typeparam>
        [SuppressMessage("ReSharper", "InconsistentNaming")]
        public static async Task MatchAwait<TInput>(this Task<Result<TInput>> res, Func<TInput, Task> Success,
        ...
        /// <returns>Object of type T</returns>
        [SuppressMessage("ReSharper", "InconsistentNaming")]
        public static async Task<T> Match<TInput, T>(this Task<Result<TInput>> res, Func<TInput, T> Success,
        ...
        /// <typeparam name="TInput">Type of the input Result</typeparam>
        [SuppressMessage("ReSharper", "InconsistentNaming")]
        public static async Task Match<TInput>(this Task<Result<TInput>> res, Action<TInput> Success,
        ...
        public static Task<Result<TSucc>> DoAwait<TSucc, TResult>(this Task<Result<TSucc>> res, DoType type,
        ...
        /// <returns>Async of either the Success, or a Failure</returns>
        public static Task<Result<TSucc>> DoAwait<TSucc, TResult>(this Task<Result<TSucc>> res, DoType type,
            Func<TSucc, Task<TResult>> function, ExceptionFilter mapException)
        {
        ...
        public static Task<Result<TSucc>> DoAwait<TSucc>(this Task<Result<TSucc>> res, DoType type,
            Func<TSucc, Task> function, ExceptionFilter mapException)
        {
            return res.DoAwait(type, function.ToAsyncResultFunc(mapException));
        }
        ...
        /// <typeparam name="TResult">The type of the result of the computation (unused)</typeparam>
        /// <returns>Async of either the Success, or a Failure</returns>
        public static async Task<Result<TSucc>> Do<TSucc, TResult>(this Task<Result<TSucc>> res, DoType type,
        ...
        /// <typeparam name="TResult">The type of the result of the computation (unused)</typeparam>
        /// <returns>Async of either the Success, or a Failure</returns>
        public static Task<Result<TSucc>> Do<TSucc, TResult>(this Task<Result<TSucc>> res, DoType type,
        ...
        /// <typeparam name="TSucc">Input type</typeparam>
        /// <returns>Async of either a Success of Unit, or a Failure</returns>
        public static Task<Result<TSucc>> Do<TSucc>(this Task<Result<TSucc>> res, DoType type, Action<TSucc> function,
            ExceptionFilter mapException)
        {
            return res.Do(type, function.ToResultFunc(mapException));
        }
        ...
        public static Task<Result<TResult>> ThenAwait<TSucc, TResult>(this Task<Result<TSucc>> res,
            Func<TSucc, Task<Result<TResult>>> function)
        {
        ...
        public static Task<Result<Unit>> ThenAwait<TSucc>(this Task<Result<TSucc>> res, Func<TSucc, Task> function,
            ExceptionFilter mapException)
        {
            return res.ThenAwait(function.ToAsyncResultFunc(mapException));
        }
        ...
        /// <typeparam name="TResult">The type of the result of the computation</typeparam>
        /// <returns>Async of either a Success from the computation, or a Failure</returns>
        public static async Task<Result<TResult>> Then<TSucc, TResult>(this Task<Result<TSucc>> res,
            Func<TSucc, Result<TResult>> function)
        {
            var result = await res;
        ...
        /// <typeparam name="TResult">The type of the result of the computation</typeparam>
        /// <returns>Async of either a Success from the computation, or a Failure</returns>
        public static Task<Result<TResult>> Then<TSucc, TResult>(this Task<Result<TSucc>> res,
            Func<TSucc, TResult> function, ExceptionFilter mapException)
        {
        ...
        /// <typeparam name="TSucc">Input type</typeparam>
        /// <returns>Async of either a Success containing Unit, or a Failure</returns>
        public static Task<Result<Unit>> Then<TSucc>(this Task<Result<TSucc>> res, Action<TSucc> function,
            ExceptionFilter mapException)
        {
            return res.Then(function.ToResultFunc(mapException));
        }
        ...
        /// <typeparam name="TSucc">Input type</typeparam>
        /// <returns>Async of either the Success, or a Failure</returns>
        public static Task<Result<TSucc>> AssertAwait<TSucc>(this Task<Result<TSucc>> res,
            Func<TSucc, Task<Result<bool>>> assertion, string? assertionMessage = null)
        {
            var curr = res;
        ...
        /// <returns>Async of either the Success, or a Failure</returns>
        public static Task<Result<TSucc>> AssertAwait<TSucc>(this Task<Result<TSucc>> res,
            Func<TSucc, Task<bool>> assertion, ExceptionFilter mapException, string? assertionMessage = null)
        {
        ...
        /// <typeparam name="TSucc">Input type</typeparam>
        /// <returns>Async of either the Success, or a Failure</returns>
        public static async Task<Result<TSucc>> Assert<TSucc>(this Task<Result<TSucc>> res,
        ...
        /// <typeparam name="TSucc">Input type</typeparam>
        /// <returns>Async of either the Success, or a Failure</returns>
        public static Task<Result<TSucc>> Assert<TSucc>(this Task<Result<TSucc>> res, Func<TSucc, bool> assertion,
        ...
        [SuppressMessage("ReSharper", "InconsistentNaming")]
        public static Task<Result<TResult>> IfAwait<TSucc, TResult>(this Task<Result<TSucc>> res,
            Func<TSucc, Task<Result<bool>>> predicate, Func<TSucc, Task<Result<TResult>>> Then,
            Func<TSucc, Task<Result<TResult>>> Else)
        {
            var curr = res;
            return curr.ThenAwait(predicate)
                .ThenAwait(predicateResult => predicateResult ? curr.ThenAwait(Then) : curr.ThenAwait(Else));
        }
        ...
        /// <returns>Either the Success, or a Failure</returns>
        [SuppressMessage("ReSharper", "InconsistentNaming")]
        public static async Task<Result<TResult>> If<TSucc, TResult>(this Task<Result<TSucc>> res,
            Func<TSucc, Result<bool>> predicate, Func<TSucc, Result<TResult>> Then,
